...
const expandMapButton = document.querySelector('.map-buttons__button--expand');
const printMapButton = document.querySelector('.map-buttons__button--print');
const mapToPrint = document.querySelector('#pvz-map');
...
if (expandMapButton && mapToPrint && overlay) {
	const ovelayClose = mapPopup.querySelector('.close-element');
